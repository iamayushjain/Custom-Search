 ...
 */
public class SearchResultOnResult extends Activity implements IHODClientCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stringToSearch = s;
        //initView();
        animatedCircleLoadingView = new AnimatedCircleLoadingView(this);
...
//    }
    void performSearch(String searchedString) {
        Intent i = new Intent(SearchResultOnResult.this, SearchResultOnResult.class);
